...
class MediaFileModel(Base, TimestampMixin):
    ...
    media_versions: Mapped[list["MediaVersionModel"]] = mapped_column(relationship("MediaVersionModel", back_populates="media_file"))
    processing_task:Mapped["ProcessingTaskModel"] = mapped_column(relationship("ProcessingTaskModel", back_populates="media_file", uselist=False))